...
# Wordpress Demo Theme (WordPress theme hierarchy) 
> **Note:** This repository contains the core code of a demo theme for WordPress (My starter template for WordPress theme development)
...
## About The Project
WordPress is a free and open-source content management system written in PHP and paired with a MySQL or MariaDB database. Features include a plugin architecture and a template system, referred to within WordPress as Themes. In this project i have made a starter template for WordPress theme development.
### Built With
...
* Organized starter template for WordPress theme development
* All the template files implemented by following WordPress theme hierarchy  
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/Wordpress-Demo-Theme.git
```
2. Make a zip file (By default, it may be zipped. if already zipped, don't need to follow this step)
3. Install this theme as like normal theme. (Need to show your local path of the theme's location)
